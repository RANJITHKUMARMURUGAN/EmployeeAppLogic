...
<head>
    ...
    <title>
        <g:layoutTitle default="Employee PayRoll Application Grails"/>
    </title>
...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark rounded">
        <a class="navbar-brand" href="#">EmployeePayRollApp</a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="dol-sm-9 ml-sm-auto col-md-10 pt-3">
            <g:layoutBody/>
        </main>
    </div>
</div>
